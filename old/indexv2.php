...
<div class="container">
  <div class="row">
    <form class="col s12" method="POST" action="#">
      <div class="row">
        <div class="input-field col m7 s6">
            <input id="nomeCurso" type="text" class="contar" data-length="80" onkeyup="trocarTitulo()">
      ...
      <div class="row">
        <div class="input-field col s3">
            <input id="datainicial" type="text" class="datepicker" onchange="trocarTitulo()">
            <label for="datainicial">Data do Curso</label>
        </div>
        <div class="input-field col s3">
            <input id="datafinal" type="text" class="datepicker" onchange="trocarTitulo()">
    ...
    <div class="row">
        <div class="input-field col s3">
            <input id="InscricoesInicio" type="text" class="datepicker">
            <label for="InscricoesInicio">Início das Inscrições</label>
        </div>
        <div class="input-field col s3">
            <input id="InscricoesFim" type="text" class="datepicker">
    ...
    <div class="row">
        <div class="input-field col s12">
            <table>
                <tr>
                    ...
                    <tr><input type="checkbox" class="filled-in"/>
        ...
        <div style="display: none" id="divJanela2" class="col s3">
            <div class="input-field row">
        ...
        <div style="display: none" id="divJanela3" class="col s3">
            <div class="input-field row">
        ...
        <div style="display: none" id="divJanela4" class="col s3">
            <div class="input-field row">
